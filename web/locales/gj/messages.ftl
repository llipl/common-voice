...
email-opt-in-privacy = ઇમેઇલ્સ પ્રાપ્ત કરવાનું પસંદ કરીને, તમે જણાવી શકો છો કે અમારી <privacyLink> ગોપનીયતા નીતિ <ગોપનીયતા નીતિ <privacyLink> માં સમજાવાયેલ આ માહિતીને હેન્ડલ કરવા માટે તમે અમારી સાથે સંમત છો.
...
cookies = કૂકીઝ
faq = FAQ
content-license-text = <licenseLink> ક્રિએટીવ કonsમન્સ લાઇસેંસ </licenseLink> હેઠળ ઉપલબ્ધ સામગ્રી
...
status-hours  
{ $hours -> 
[one] અત્યાર સુધીનો એક માન્ય કલાક!
* [other] { $hours } માન્ય સમય સુધીના કલાકો!
} 
# Variables: 
...
સૂચનો છે & amp; પ્રતિસાદ? <discourseLink> ફોરમ્સ </discourseLink> પર શેર કરો,
મુદ્દો મળ્યો કે ભૂલ? <githubLink> GitHub </githubLink> પર તેની જાણ કરો.
અથવા અન્ય કોઈપણ બાબતો માટે અમારો સંપર્ક કરો. <contactLink> ઇમેઇલ </ contactLink>.
...
માઇક્રોફ્ટ ગમે ત્યાં ચાલે છે - ડેસ્કટ computerપ કમ્પ્યુટર પર, omટોમોબાઈલની અંદર, અથવા રાસ્પબેરી પાઇ પર.
...
કોમન વ Voiceઇસનું મલ્ટિ-લેંગ્વેજ ડેટાસેટ પહેલેથી જ તેની પ્રકારની સૌથી મોટી જાહેરમાં ઉપલબ્ધ વ voiceઇસ ડેટાસેટ છે, પરંતુ તે એકમાત્ર નથી.
આ પૃષ્ઠને અન્ય ખુલ્લા સ્રોત વ voiceઇસ ડેટાસેટ્સના સંદર્ભ કેન્દ્ર તરીકે જુઓ અને, જેમ કે સામાન્ય અવાજ વધતો જાય છે, તે અમારા પ્રકાશન અપડેટ્સનું ઘર છે.
language = ભાષા
...
ડેટાસેટમાં દરેક એન્ટ્રીમાં એક અનન્ય એમપી 3 અને સંબંધિત ટેક્સ્ટ ફાઇલ હોય છે. ડેટાસેટમાં નોંધાયેલા ઘણા <b>{ $total }</b> કલાકોમાં વય, લિંગ અને ઉચ્ચાર જેવા વસ્તી વિષયક મેટાડેટા શામેલ હોય છે જે વાણી ઓળખાણ એન્જિનની ચોકસાઈને તાલીમ આપવામાં સહાય કરી શકે છે.
ડેટાસેટમાં હાલમાં  <b>{ $valid }</b> માન્ય કલાકો શામેલ છે <b>{ $languages }</b> ભાષાઓમાં, પરંતુ અમે હંમેશાં વધુ અવાજો અને ભાષાઓ ઉમેરીશું. કોઈ ભાષાની વિનંતી કરવા અથવા ફાળો આપવાનું શરૂ કરવા માટે અમારા <languagesLink> ભાષાઓ પૃષ્ઠ </languagesLink> પર એક નજર નાખો. 
...
common-voice-info-new = સામાન્ય અવાજ વિશે પ્રશ્નો છે? કોઈ ચોક્કસ ભાષા વિશેના સુધારાઓ અથવા પ્રતિસાદ માટેના વિચારો? અમારા <discourseLink> ડિસ્કourseર્સ ફોરમ </ discourseLink> પર જોડાઓ અને અમને જણાવો.
...
language-section-in-progress-new-description = આ ભાષાઓ હાલમાં સમુદાયના વિકાસ હેઠળ છે. પ્રગતિ પટ્ટીઓ સૂચવે છે કે દરેક ભાષા <localizationGlossaryLink> વેબસાઇટ સ્થાનિકીકરણ </ localizationGlossaryLink> અને <sentenceCollectionGlossaryLink> વાક્ય સંગ્રહ </sentenceCollectionGlossaryLink> ની પ્રક્રિયામાં કેટલી દૂર છે.
language-section-launched = શરૂ
language-section-launched-description = આ શરૂ થયેલી ભાષાઓ માટે વેબસાઇટ સફળતાપૂર્વક <localizationGlossaryLink> સ્થાનિક થયેલ છે </localizationGlossaryLink> કરવામાં આવી છે, અને તેમાં પૂરતી <sentenceCollectionGlossaryLink> વાક્યો એકત્રિત કરવામાં આવી છે  </sentenceCollectionGlossaryLink> ચાલુ રાખવા માટે પરવાનગી આપવા માટે  <speakLink> બોલો </ speakLink> અને <listenLink>સાંભળો </listenLink> યોગદાન.
...
contribute-more  
{ $count -> 
*[other] વધુ કરવા માટ { $count } તૈયાર છો?
} 
...
શું તમે અમને જણાવો કે તમે કેમ રેકોર્ડિંગ્સ કા deletedી નાખવા માંગો છો?
profile-form-delete = પ્રોફાઇલ કા Deleteી નાખો
...
login-company = In $ કંપની} ઇમેઇલ સાથે લ Inગ ઇન / સાઇન અપ કરો
