...
cookies = કૂકીઝ
faq = FAQ
content-license-text = <licenseLink> ક્રિએટીવ કonsમન્સ લાઇસેંસ </ translation> લિક્સેલિંક> હેઠળ ઉપલબ્ધ સામગ્રી
...
deepspeech-info = કોમન વ datઇસ ડેટાસેટ મોઝિલાના ખુલ્લા સ્ત્રોત વ .ઇસ રેકગ્નિશન એન્જિન ડીપ સ્પીચને પૂરક બનાવે છે, જેનો તમે ભાષણ ઓળખ એપ્લિકેશન બનાવવા માટે વાપરી શકો છો. કેવી રીતે પ્રારંભ કરવું તે શીખવા માટે અમારું <githubLink> ગિથબ વિહંગાવલોકન </ githubLink> અથવા <discourseLink> ડીપસ્પીક પ્રવચનમાં જોડાઓ </ ડિસ્કર્સલિંક> વાંચો.
common-voice-info-new = સામાન્ય અવાજ વિશે પ્રશ્નો છે? કોઈ ચોક્કસ ભાષા વિશેના સુધારાઓ અથવા પ્રતિસાદ માટેના વિચારો? અમારા <ડિસકોર્સલિંક> ડિસ્કourseર્સ ફોરમ </ ડિસ્કourseર્સલિંક> પર જોડાઓ અને અમને જણાવો.
...
language-section-in-progress-new-description = આ ભાષાઓ હાલમાં સમુદાયના વિકાસ હેઠળ છે. પ્રગતિ પટ્ટીઓ સૂચવે છે કે દરેક ભાષા <localizationGlossaryLink> વેબસાઇટ સ્થાનિકીકરણ </ સ્થાનિકીકરણ ગ્લોસરીલિંક> અને <સેન્સનટેકશન ગ્લોસરીલિંક> વાક્ય સંગ્રહ </ translation> ગ્લોસરીલિંક> ની પ્રક્રિયામાં કેટલી દૂર છે.
language-section-launched = શરૂ
language-section-launched-description = આ શરૂ થયેલી ભાષાઓ માટે વેબસાઇટ સફળતાપૂર્વક <localizationGlossaryLink> સ્થાનિક થયેલ છે </ સ્થાનિકીકરણ ગ્લોસરીલિંક> કરવામાં આવી છે, અને તેમાં પૂરતી <સેન્સિટ કલેક્શનગ્લોસરીલિંક> વાક્યો એકત્રિત કરવામાં આવી છે </ spanLink> બોલો </ speakLink> સાંભળો </ સાંભળો / સાંભળો > યોગદાન.
