...
get-involved-form-title = { $lang } کی تازہ کاریوں کے لئے سائن اپ کریں:
get-involved-email =
    .label = ای میل
get-involved-opt-in = جی ہاں، مجھے ای میل ارسال کریں ۔ میں Lok Vacha پر اس زبان کی ترقی کے بارے میں باخبر رہنا چاہوں گا.
