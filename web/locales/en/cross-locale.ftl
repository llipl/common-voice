...
get-involved-email =
  .label = Email
get-involved-opt-in = Yes, send me emails. I'd like to stay informed about the progress of this language on project lok.vacha.
get-involved-submit = Submit
get-involved-stayintouch = We would like to stay in touch with updates, new data sources and to hear more about how you're using this data.
